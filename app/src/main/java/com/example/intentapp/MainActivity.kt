...
import com.example.intentapp.R.id.btn_move_activity
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnMoveWtihObject: Button =
            findViewById(R.id.btn_move_activity_object)
        btnMoveWtihObject.setOnClickListener(this)
    }
    ...
    override fun onClick(v: View?) {
      when (v?.id) {
          ...
          R.id.btn_move_activity_object -> {
              ...
              MoveWtihObjectActivity::class.java)
              moveWithObjectIntent.putExtra(MoveWtihObjectActivity.EXTRA_PERSON,person)
